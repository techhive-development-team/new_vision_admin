...
import { Home, Users, Image, BookOpen, Building2, Calendar1, MessageSquare, PlaneTakeoff } from "lucide-react";
...
export const sidebarRoutes: SidebarRoute[] = [
  ...
  { path: "/futureCountry", name: "Future Country", icon: <PlaneTakeoff size={18}/>}
];
